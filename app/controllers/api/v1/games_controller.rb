class Api::V1::GamesController < ApplicationController
  ...
  def new_game
    respond_with({:code => HttpResponse::CODE_ERROR_MISSING_PARAMETER, :message => HttpResponse.code_msg(HttpResponse::CODE_ERROR_MISSING_PARAMETER)}, :location => '') and return unless params[:player_name]
    ...
    begin
      ...
      respond_with({:code => HttpResponse::CODE_SUCCESS, :message => HttpResponse.code_msg(HttpResponse::CODE_SUCCESS),
                    :game_id => game.id, :player_key => gp.player_key}, :location => '')
    rescue Exception => e
  ...
  def join
    respond_with({:code => HttpResponse::CODE_ERROR_MISSING_PARAMETER, :message => HttpResponse.code_msg(HttpResponse::CODE_ERROR_MISSING_PARAMETER)}, :location => '') and return unless params[:player_name] && params[:game_id]
    ...
    begin
      ...
      if add_return.is_a? Hash
        ...
        respond_with({:code => HttpResponse::CODE_SUCCESS, :message => HttpResponse.code_msg(HttpResponse::CODE_SUCCESS),
                      :board => game.current_board, :player_key => add_return.player_key}, :location => '')
      end
